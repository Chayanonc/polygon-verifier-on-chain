...
async function main() {
  ...
  const schemaBigInt = "117337771401500307917377954291034173732";

  // const type = "KYCAgeCredential";
  const type = "ZKAgeAirdrop";
  const schemaUrl = "ipfs://QmT52QVjeXor52Z1bMbdMoABHTcjZbWPuXTVkBRasBy9FM";

  // merklized path to field in the W3C credential according to JSONLD  schema e.g. birthday in the KYCAgeCredential under the url "https://raw.githubusercontent.com/iden3/claim-schema-vocab/main/schemas/json-ld/kyc-v3.json-ld"
  const schemaClaimPathKey =
    "13739199202370286551675740822074293736380906300092700594036187370392135274946";
  ...
  const query = {
    ...
    slotIndex: 0,
    value: [24, ...new Array(63).fill(0)], // for operators 1-3 only first value matters
  ...
  const ERC20VerifierAddress = "0xc51e727bC6ab8B546f1Da761566d414Bcef0A30F";
